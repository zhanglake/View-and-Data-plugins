!
function(e, t) {
	"object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports["Viewing.Extension.StateManager"] = t() : e["Viewing.Extension.StateManager"] = t()
}(this, function() {
	return function(e) {
		function t(r) {
		...
		0: function(e, t, n) {
			...
			var u = function() {
				...
				m = function(e) {
					function t(e, n) {
						...
						return r._options.apiUrl && (r._api = new p["default"](n.apiUrl)), r
					}
					return s(t, e), u(t, [{
						key: "load",
						value: function() {
							var e = this;
							if (this._control = h["default"].createButton("state-manager-control", "glyphicon glyphicon-retweet", "Manage States", function() {
								e._panel.toggleVisibility()
							}), this.onAddStateHandler = function(t) {
								return e.onAddState(t)
							}, this.onRestoreStateHandler = function(t) {
								return e.onRestoreState(t)
							}, this.onRemoveStateHandler = function(t) {
								return e.onRemoveState(t)
							}, this.onSaveSequenceHandler = function(t) {
								return e.onSaveSequence(t)
							}, this._panel = new l["default"](this._viewer.container, this._control.container), this._panel.on("state.add", function(t) {
								return e.onAddStateHandler(t)
							}), this._panel.on("state.restore", function(t) {
								return e.onRestoreStateHandler(t)
							}), this._panel.on("state.remove", function(t) {
								return e.onRemoveStateHandler(t)
							}), this._panel.on("sequence.update", function(t) {
								return e.onSaveSequenceHandler(t)
							}), this.parentControl = this._options.parentControl, !this.parentControl) {
								var t = this._viewer.getToolbar(!0);
								this.parentControl = new Autodesk.Viewing.UI.ControlGroup("state-manager"), t.addControl(this.parentControl)
							}
							if (this.parentControl.addControl(this._control), this._api && this._api.getSequence(this._options.model._id).then(function() {
								var t = i(regeneratorRuntime.mark(function n(t) {
									var r;
									return regeneratorRuntime.wrap(function(n) {
										for (;;) switch (n.prev = n.next) {
										case 0:
											return n.next = 2, e._api.getStates(e._options.model._id);
										case 2:
											r = n.sent, t.forEach(function(t) {
												r.forEach(function(n) {
													n.guid == e._options.stateId && e._viewer.restoreState(n, !1), n.guid == t && e._panel.addItem(n)
												})
											});
										case 4:
										case "end":
							...
							}()), this._options.homeState) {
								var n = this._viewer.getState();
								n.name = "Home", n.readonly = !0, this._panel.addItem(n)
							}
							return this._panel.setVisible(this._options.showPanel), console.log("Viewing.Extension.StateManager loaded"), !0
						}
					}, {
						key: "unload",
						value: function() {
							return this.parentControl.removeControl(this._control), this._panel.setVisible(!1), console.log("Viewing.Extension.StateManager unloaded"), !0
						}
					}, {
						key: "onAddState",
						value: function(e) {
							var t = this._viewer.getState();
							return t.name = e.name.length ? e.name : (new Date).toString("d/M/yyyy H:mm:ss"), this._api && this._api.addState(this._options.model._id, t), t
						}
					}, {
						key: "onRestoreState",
						value: function(e) {
							this._viewer.restoreState(e, null, !1)
						}
					}, {
						key: "onRemoveState",
						value: function(e) {
							this._api && this._api.removeState(this._options.model._id, e.guid)
						}
					}, {
						key: "onSaveSequence",
						value: function(e) {
							this._api && this._api.saveSequence(this._options.model._id, e)
						}
					}], [{
						key: "ExtensionId",
						get: function() {
			...
			Autodesk.Viewing.theExtensionManager.registerExtension(m.ExtensionId, m)
		},
		1: function(e, t, n) {
			var r, i;
			!
			function(t, n) {
				...
				function d(e, t, n, r) {
					...
					function() {
						...
						return ce.css(e, t, "")
					}, u = s(), c = n && n[3] || (ce.cssNumber[t] ? "" : "px"), l = (ce.cssNumber[t] || "px" !== c && +u) && Le.exec(ce.css(e, t));
					if (l && l[3] !== c) {
						c = c || l[3], n = n || [], l = +u || 1;
				...
				function g(e, t, n, r, i) {
					for (var o, a, s, u, c, l, f = t.createDocumentFragment(), p = [], d = 0, g = e.length; g > d; d++) if (o = e[d], o || 0 === o) if ("object" === ce.type(o)) ce.merge(p, o.nodeType ? [o] : o);
					else if (ze.test(o)) {
						for (a = a || f.appendChild(t.createElement("div")), s = (He.exec(o) || ["", ""])[1].toLowerCase(), u = Fe[s] || Fe._default, a.innerHTML = u[1] + ce.htmlPrefilter(o) + u[2], l = u[0]; l--;) a = a.lastChild;
						ce.merge(p, a.childNodes), a = f.firstChild, a.textContent = ""
					} else p.push(t.createTextNode(o));
					for (f.textContent = "", d = 0; o = p[d++];) if (r && ce.inArray(o, r) > -1) i && i.push(o);
					else if (c = ce.contains(o.ownerDocument, o), a = h(f.appendChild(o), "script"), c && v(a), n) for (l = 0; o = a[l++];) Me.test(o.type || "") && n.push(o);
					return f
				}
				function m() {
					return !0
				...
				function S(e, t, n, r) {
					...
					var i, o, a, s, u, c, l = 0,
						...
						d = t[0],
						v = ce.isFunction(d);
					if (v || f > 1 && "string" == typeof d && !se.checkClone && Xe.test(d)) return e.each(function(i) {
						var o = e.eq(i);
						v && (t[0] = d.call(this, i, o.html())), S(o, t, n, r)
					});
					if (f && (i = g(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
						...
						if (s) for (c = a[a.length - 1].ownerDocument, ce.map(a, C), l = 0; s > l; l++) u = a[l], Me.test(u.type || "") && !Ae.access(u, "globalEval") && ce.contains(c, u) && (u.src ? ce._evalUrl && ce._evalUrl(u.src) : ce.globalEval(u.textContent.replace(Ge, "")))
					}
					return e
				}
				function N(e, t, n) {
					for (var r, i = t ? ce.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || ce.cleanData(h(r)), r.parentNode && (n && ce.contains(r.ownerDocument, r) && v(h(r, "script")), r.parentNode.removeChild(r));
					return e
				}
				function j(e, t) {
				...
				function L(e, t, n, r, i) {
					for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)"margin" === n && (a += ce.css(e, n + Pe[o], !0, i)), r ? ("content" === n && (a -= ce.css(e, "padding" + Pe[o], !0, i)), "margin" !== n && (a -= ce.css(e, "border" + Pe[o] + "Width", !0, i))) : (a += ce.css(e, "padding" + Pe[o], !0, i), "padding" !== n && (a += ce.css(e, "border" + Pe[o] + "Width", !0, i)));
					return a
				}
				function P(e, t, r) {
					var i = !0,
						...
						a = et(e),
						s = "border-box" === ce.css(e, "boxSizing", !1, a);
					if (Z.msFullscreenElement && n.top !== n && e.getClientRects().length && (o = Math.round(100 * e.getBoundingClientRect()[t])), 0 >= o || null == o) {
						if (o = O(e, t, a), (0 > o || null == o) && (o = e.style[t]), Ze.test(o)) return o;
						i = s && (se.boxSizingReliable() || o === e.style[t]), o = parseFloat(o) || 0
					}
					return o + L(e, t, r || (s ? "border" : "content"), i, a) + "px"
				}
				function q(e, t) {
					for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = Ae.get(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && qe(r) && (o[a] = Ae.access(r, "olddisplay", A(r.nodeName)))) : (i = qe(r), "none" === n && i || Ae.set(r, "olddisplay", i ? n : ce.css(r, "display"))));
				...
				function z(e, t, n) {
					...
					if (ce.isEmptyObject(p))"inline" === ("none" === c ? A(e.nodeName) : c) && (d.display = c);
						...
						v ? "hidden" in v && (h = v.hidden) : v = Ae.access(e, "fxshow", {}), o && (v.hidden = !h), h ? ce(e).show() : f.done(function() {
							ce(e).hide()
						}), f.done(function() {
							var t;
							Ae.remove(e, "fxshow");
						...
						for (r in p) a = F(h ? v[r] : 0, r, f), r in v || (v[r] = a.start, h && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
					}
				}
				function B(e, t) {
					var n, r, i, o, a;
				...
				function W(e, t, n) {
					var r, i, o = 0,
						...
						u = function() {
							if (i) return !1;
							for (var t = ut || H(), n = Math.max(0, c.startTime + c.duration - t), r = n / c.duration || 0, o = 1 - r, a = 0, u = c.tweens.length; u > a; a++) c.tweens[a].run(o);
						...
						l = c.props;
					for (B(l, c.opts.specialEasing); a > o; o++) if (r = W.prefilters[o].call(c, e, l, c.opts)) return ce.isFunction(r.stop) && (ce._queueHooks(c.elem, c.opts.queue).stop = ce.proxy(r.stop, r)), r;
					return ce.map(l, F, c), ce.isFunction(c.opts.start) && c.opts.start.call(e, c), ce.fx.timer(ce.extend(u, {
						elem: e,
						anim: c,
						queue: c.opts.queue
				...
				function J(e, t, n, r) {
					...
					if (ce.isArray(t)) ce.each(t, function(t, i) {
						n || Lt.test(e) ? r(e, i) : J(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r)
					});
				...
				ce.fn = ce.prototype = {
					...
					each: function(e, t) {
						var n, r = 0;
						if (a(e)) for (n = e.length; n > r && t.call(e[r], r, e[r]) !== !1; r++);
					...
					map: function(e, t, n) {
						var r, i, o = 0,
							s = [];
						if (a(e)) for (r = e.length; r > o; o++) i = t(e[o], o, n), null != i && s.push(i);
				...
				var he = function(e) {
						function t(e, t, n, r) {
							var i, o, a, s, u, c, f, d, h = t && t.ownerDocument,
								v = t ? t.nodeType : 9;
							if (n = n || [], "string" != typeof e || !e || 1 !== v && 9 !== v && 11 !== v) return n;
							if (!r && ((t ? t.ownerDocument || t : F) !== _ && D(t), t = t || _, L)) {
								...
								if (w.qsa && !$[e + " "] && (!P || !P.test(e))) {
									if (1 !== v) h = t, d = e;
										...
										for ((s = t.getAttribute("id")) ? s = s.replace(xe, "\\$&") : t.setAttribute("id", s = M), f = E(e), o = f.length, u = pe.test(s) ? "#" + s : "[id='" + s + "']"; o--;) f[o] = u + " " + p(f[o]);
						...
						function d(e, t, n) {
							...
							function(t, n, o) {
								...
								if (a) {
									...
									if (c = t[M] || (t[M] = {}), u = c[t.uniqueID] || (c[t.uniqueID] = {}), (s = u[r]) && s[0] === z && s[1] === o) return l[2] = s[2];
						...
						function y(e) {
							for (var t, n, r, i = e.length, o = T.relative[e[0].type], a = o || T.relative[" "], s = o ? 1 : 0, u = d(function(e) {
								...
								return t = null, i
							}]; i > s; s++) if (n = T.relative[e[s].type]) l = [d(h(l), n)];
							else {
							...
							var i = n.length > 0,
								...
								a = function(r, a, s, u, c) {
									var l, f, p, d = 0,
										...
										w = x.length;
									for (c && (j = a === _ || a || c); h !== w && null != (l = x[h]); h++) {
										if (o && l) {
											for (f = 0, a || l.ownerDocument === _ || (D(l), s = !L); p = e[f++];) if (p(l, a || _, s)) {
												u.push(l);
												break
											}
											c && (z = b)
									...
									if (d += h, i && h !== d) {
										...
										if (r) {
											if (d > 0) for (; h--;) v[h] || m[h] || (m[h] = J.call(u));
											m = g(m)
										}
						...
						var b, w, T, C, k, E, S, N, j, A, O, D, _, R, L, P, q, I, H, M = "sizzle" + 1 * new Date,
							F = e.document,
							z = 0,
							B = 0,
							W = n(),
						...
						w = t.support = {}, k = t.isXML = function(e) {
							...
							return r !== _ && 9 === r.nodeType && r.documentElement ? (_ = r, R = _.documentElement, L = !k(_), (n = _.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), w.attributes = i(function(e) {
								return e.className = "i", !e.getAttribute("className")
							}), w.getElementsByTagName = i(function(e) {
								return e.appendChild(_.createComment("")), !e.getElementsByTagName("*").length
							}), w.getElementsByClassName = ge.test(_.getElementsByClassName), w.getById = i(function(e) {
								return R.appendChild(e).id = M, !_.getElementsByName || !_.getElementsByName(M).length
							...
							}, q = [], P = [], (w.qsa = ge.test(_.querySelectorAll)) && (i(function(e) {
							...
							})), (w.matchesSelector = ge.test(I = R.matches || R.webkitMatchesSelector || R.mozMatchesSelector || R.oMatchesSelector || R.msMatchesSelector)) && i(function(e) {
								w.disconnectedMatch = I.call(e, "div"), I.call(e, "[s!='']:x"), q.push("!=", oe)
							}), P = P.length && new RegExp(P.join("|")), q = q.length && new RegExp(q.join("|")), t = ge.test(R.compareDocumentPosition), H = t || ge.test(R.contains) ?
							function(e, t) {
							...
							function(e, t) {
								...
								return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === _ || e.ownerDocument === F && H(F, e) ? -1 : t === _ || t.ownerDocument === F && H(F, t) ? 1 : A ? ee(A, e) - ee(A, t) : 0 : 4 & n ? -1 : 1)
							} : function(e, t) {
								if (e === t) return O = !0, 0;
								var n, r = 0,
									i = e.parentNode,
									...
									s = [e],
									u = [t];
								if (!i || !o) return e === _ ? -1 : t === _ ? 1 : i ? -1 : o ? 1 : A ? ee(A, e) - ee(A, t) : 0;
								if (i === o) return a(e, t);
							...
							if ((e.ownerDocument || e) !== _ && D(e), n = n.replace(le, "='$1']"), w.matchesSelector && L && !$[n + " "] && (!q || !q.test(n)) && (!P || !P.test(n))) try {
								var r = I.call(e, n);
							...
							var t, n = [],
								r = 0,
								i = 0;
							if (O = !w.detectDuplicates, A = !w.sortStable && e.slice(0), e.sort(V), O) {
									...
									function(e) {
										...
										if (g) {
											...
											if (h = [a ? g.firstChild : g.lastChild], a && y) {
												for (p = g, f = p[M] || (p[M] = {}), l = f[p.uniqueID] || (f[p.uniqueID] = {}), c = l[e] || [], d = c[0] === z && c[1], x = d && c[2], p = d && g.childNodes[d]; p = ++d && p && p[v] || (x = d = 0) || h.pop();) if (1 === p.nodeType && ++x && p === t) {
													l[e] = [z, d, x];
													break
												}
											} else if (y && (p = t, f = p[M] || (p[M] = {}), l = f[p.uniqueID] || (f[p.uniqueID] = {}), c = l[e] || [], d = c[0] === z && c[1], x = d), x === !1) for (;
											(p = ++d && p && p[v] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && (f = p[M] || (p[M] = {}), l = f[p.uniqueID] || (f[p.uniqueID] = {}), l[e] = [z, x]), p !== t)););
						...
						return f.prototype = T.filters = T.pseudos, T.setFilters = new f, E = t.tokenize = function(e, n) {
							...
							return (c || S(e, f))(r, t, !L, n, !t || ye.test(e) && l(t.parentNode) || t), n
						}, w.sortStable = M.split("").sort(V).join("") === M, w.detectDuplicates = !! O, D(), w.sortDetached = i(function(e) {
						...
						l = {
							...
							remove: function() {
								return ce.each(arguments, function(e, t) {
									for (var n;
									(n = ce.inArray(t, o, n)) > -1;) o.splice(n, 1), s >= n && s--
								}), this
							},
							has: function(e) {
				...
				ce.extend({
					hasData: function(e) {
						return Oe.hasData(e) || Ae.hasData(e)
					},
					data: function(e, t, n) {
					...
					data: function(e, t) {
						var n, r, i, o = this[0],
							a = o && o.attributes;
						if (void 0 === e) {
							if (this.length && (i = Oe.get(o), 1 === o.nodeType && !Ae.get(o, "hasDataAttrs"))) {
						...
						return "object" == typeof e ? this.each(function() {
							...
							var n, r;
							if (o && void 0 === t) {
								if (n = Oe.get(o, e) || Oe.get(o, e.replace(_e, "-$&").toLowerCase()), void 0 !== n) return n;
								if (r = ce.camelCase(e), n = Oe.get(o, r), void 0 !== n) return n;
				...
				ce.event = {
					...
					add: function(e, t, n, r, i) {
						var o, a, s, u, c, l, f, p, d, h, v, g = Ae.get(e);
						if (g) for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = ce.guid++), (u = g.events) || (u = g.events = {}), (a = g.handle) || (a = g.handle = function(t) {
							return "undefined" != typeof ce && ce.event.triggered !== t.type ? ce.event.dispatch.apply(e, arguments) : void 0
						}), t = (t || "").match(Ee) || [""], c = t.length; c--;) s = Ue.exec(t[c]) || [], d = v = s[1], h = (s[2] || "").split(".").sort(), d && (f = ce.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = ce.event.special[d] || {}, l = ce.extend({
							type: d,
							origType: v,
							data: r,
							handler: n,
					...
					remove: function(e, t, n, r, i) {
						var o, a, s, u, c, l, f, p, d, h, v, g = Ae.hasData(e) && Ae.get(e);
						if (g && (u = g.events)) {
							for (t = (t || "").match(Ee) || [""], c = t.length; c--;) if (s = Ue.exec(t[c]) || [], d = v = s[1], h = (s[2] || "").split(".").sort(), d) {
								for (f = ce.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = u[d] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = p.length; o--;) l = p[o], !i && v !== l.origType || n && n.guid !== l.guid || s && !s.test(l.namespace) || r && r !== l.selector && ("**" !== r || !l.selector) || (p.splice(o, 1), l.selector && p.delegateCount--, f.remove && f.remove.call(e, l));
								a && !p.length && (f.teardown && f.teardown.call(e, h, g.handle) !== !1 || ce.removeEvent(e, d, g.handle), delete u[d])
					...
					dispatch: function(e) {
						...
						if (s[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
							...
							(o = i.handlers[n++]) && !e.isImmediatePropagationStopped();) e.rnamespace && !e.rnamespace.test(o.namespace) || (e.handleObj = o, e.data = o.data, r = ((ce.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s), void 0 !== r && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
					...
					fix: function(e) {
						...
						var t, n, r, i = e.type,
							o = e,
							a = this.fixHooks[i];
						for (a || (this.fixHooks[i] = a = We.test(i) ? this.mouseHooks : Be.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new ce.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
				...
				ce.extend({
					...
					clone: function(e, t, n) {
						...
						if (t) if (n) for (o = o || h(e), a = a || h(s), r = 0, i = o.length; i > r; r++) k(o[r], a[r]);
						else k(e, s);
						return a = h(s, "script"), a.length > 0 && v(a, !u && h(e, "script")), s
					},
					...
					html: function(e) {
						return Ne(this, function(e) {
							...
							if ("string" == typeof e && !Ve.test(e) && !Fe[(He.exec(e) || ["", ""])[1].toLowerCase()]) {
				...
				ce.extend({
					...
					style: function(e, t, n, r) {
						if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
							var i, o, a, s = ce.camelCase(t),
								u = e.style;
							return t = ce.cssProps[s] || (ce.cssProps[s] = _(s) || s), a = ce.cssHooks[t] || ce.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = Le.exec(n)) && i[1] && (n = d(e, t, i), o = "number"), null != n && n === n && ("number" === o && (n += i && i[3] || (ce.cssNumber[s] ? "" : "px")), se.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u[t] = n)), void 0)
						}
					},
					css: function(e, t, n, r) {
						var i, o, a, s = ce.camelCase(t);
						return t = ce.cssProps[s] || (ce.cssProps[s] = _(s) || s), a = ce.cssHooks[t] || ce.cssHooks[s], a && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = O(e, t, r)), "normal" === i && t in ot && (i = ot[t]), "" === n || n ? (o = parseFloat(i), n === !0 || isFinite(o) ? o || 0 : i) : i
					}
					...
					ce.cssHooks[t] = {
						...
						set: function(e, n, r) {
							var i, o = r && et(e),
								a = r && L(e, t, r, "border-box" === ce.css(e, "boxSizing", !1, o), o);
							return a && (i = Le.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = ce.css(e, t)), R(e, n, a)
						}
					}
				}), ce.cssHooks.marginLeft = D(se.reliableMarginLeft, function(e, t) {
					return t ? (parseFloat(O(e, "marginLeft")) || e.getBoundingClientRect().left - tt(e, {
						marginLeft: 0
					}, function() {
					...
					}, Ke.test(e) || (ce.cssHooks[e + t].set = R)
				}), ce.fn.extend({
					css: function(e, t) {
				...
				ce.fn.extend({
					addClass: function(e) {
						...
						if ("string" == typeof e && e) for (t = e.match(Ee) || []; n = this[u++];) if (i = U(n), r = 1 === n.nodeType && (" " + i + " ").replace(gt, " ")) {
					...
					toggleClass: function(e, t) {
						...
						return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : ce.isFunction(e) ? this.each(function(n) {
							...
							var t, r, i, o;
							if ("string" === n) for (r = 0, i = ce(this), o = e.match(Ee) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
							else void 0 !== e && "boolean" !== n || (t = U(this), t && Ae.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : Ae.get(this, "__className__") || ""))
						})
					},
					hasClass: function(e) {
						var t, n, r = 0;
				...
				ce.extend(ce.event, {
					trigger: function(e, t, r, i) {
						...
						if (a = s = r = r || Z, 3 !== r.nodeType && 8 !== r.nodeType && !xt.test(d + ce.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), c = d.indexOf(":") < 0 && "on" + d, e = e[ce.expando] ? e : new ce.Event(d, "object" == typeof e && e), e.isTrigger = i ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : ce.makeArray(t, [e]), f = ce.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, t) !== !1)) {
							...
							for (o = 0;
							(a = p[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? u : f.bindType || d, l = (Ae.get(a, "events") || {})[e.type] && Ae.get(a, "handle"), l && l.apply(a, t), l = c && a[c], l && l.apply && je(a) && (e.result = l.apply(a, t), e.result === !1 && e.preventDefault());
				...
				_t.href = bt.href, ce.extend({
					...
					ajax: function(e, t) {
						...
						if (v.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || bt.href) + "").replace(Ct, "").replace(jt, bt.protocol + "//"), p.type = t.method || t.type || p.method || p.type, p.dataTypes = ce.trim(p.dataType || "*").toLowerCase().match(Ee) || [""], null == p.crossDomain) {
							c = Z.createElement("a");
							try {
						...
						if (p.data && p.processData && "string" != typeof p.data && (p.data = ce.param(p.data, p.traditional)), V(At, p, t, T), 2 === b) return T;
				...
				ce.param = function(e, t) {
					...
					serializeArray: function() {
						return this.map(function() {
							...
							var e = this.type;
							return this.name && !ce(this).is(":disabled") && It.test(this.nodeName) && !qt.test(e) && (this.checked || !Ie.test(e))
						}).map(function(e, t) {
							var n = ce(this).val();
				...
				se.cors = !! Mt && "withCredentials" in Mt, se.ajax = Mt = !! Mt, ce.ajaxTransport(function(e) {
					var t, r;
				...
				ce.ajaxSetup({
					...
					var i, o, a, s = e.jsonp !== !1 && (zt.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && zt.test(e.data) && "data");
					return s || "jsonp" === e.dataTypes[0] ? (i = e.jsonpCallback = ce.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(zt, "$1" + i) : e.jsonp !== !1 && (e.url += (Tt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
						return a || ce.error(i + " was not called"), a[0]
					}, e.dataTypes[0] = "json", o = n[i], n[i] = function() {
						a = arguments
					}, r.always(function() {
						void 0 === o ? ce(n).removeProp(i) : n[i] = o, e[i] && (e.jsonpCallback = t.jsonpCallback, Ft.push(i)), a && ce.isFunction(o) && o(a[0]), a = o = void 0
					}), "script") : void 0
				...
				ce.fn.load = function(e, t, n) {
					...
					setOffset: function(e, t, n) {
						var r, i, o, a, s, u, c, l = ce.css(e, "position"),
							f = ce(e),
							p = {};
					...
					ce.cssHooks[t] = D(se.pixelPosition, function(e, n) {
						return n ? (n = O(e, t), Ze.test(n) ? ce(e).position()[t] + "px" : n) : void 0
					})
				}), ce.each({
					Height: "height",
					Width: "width"
				...
				return ce.noConflict = function(e) {
					return n.$ === ce && (n.$ = Ut), e && n.jQuery === ce && (n.jQuery = Wt), ce
				}, o || (n.jQuery = n.$ = ce), ce
			})
		},
		2: function(e, t) {
		...
		5: function(e, t) {
			...
			function(e) {
				...
				return a(e, null, [{
					key: "guid",
					value: function t() {
						var e = arguments.length <= 0 || void 0 === arguments[0] ? "xxxxxxxxxxxx" : arguments[0],
							n = (new Date).getTime(),
							t = e.replace(/[xy]/g, function(e) {
					...
					value: function(e, t, n, r) {
						var i = new Autodesk.Viewing.UI.Button(e);
						return i.icon.style.fontSize = "24px", i.icon.className = t, i.setToolTip(n), i.onClick = r, i
					}
				}, {
					key: "createControlGroup",
					value: function(e, t) {
						var n = e.getToolbar(!0);
						if (n) {
							var r = new Autodesk.Viewing.UI.ControlGroup(t);
							return n.addControl(r), r
						}
					}
				}, {
					key: "nodeIdToFragIds",
					value: function(t, i) {
						...
						return new Promise(function() {
							var u = r(regeneratorRuntime.mark(function c(r, u) {
								var l, f, p, d, h;
								return regeneratorRuntime.wrap(function(o) {
									for (;;) switch (o.prev = o.next) {
									case 0:
										if (o.prev = 0, l = s || t.getData().instanceTree, f = l.dbIdToNode[i], void 0 != f) {
											o.next = 5;
											break
										}
										return o.abrupt("return", u("Invalid dbId: " + i));
									case 5:
										return p = [].concat(n(Array.isArray(f.fragIds) ? f.fragIds : [f.fragIds])), f.children && a && (d = [], f.children.forEach(function(n) {
											d.push(e.nodeIdToFragIds(t, n.dbId, a, l))
										}), h = Promise.all(d), h.forEach(function(e) {
											p = [].concat(n(p), [e])
										})), o.abrupt("return", r(p));
									case 10:
										return o.prev = 10, o.t0 = o["catch"](0), o.abrupt("return", u(o.t0));
									case 13:
									case "end":
										return o.stop()
									}
					...
					value: function(e, t) {
						var n = this;
						return new Promise(function() {
							var i = r(regeneratorRuntime.mark(function a(r, i) {
								var s, u, c;
								return regeneratorRuntime.wrap(function(n) {
									for (;;) switch (n.prev = n.next) {
									case 0:
										if (n.prev = 0, c = function() {
											var n = function i(e) {
													var t = 0;
													u.enumNodeChildren(e, function(e) {
														i(e), ++t
													}), 0 == t && s.push(e)
												};
											return s = [], u = e.getData().instanceTree, t = t || u.getRootId(), n(t), {
												v: r(s)
											}
										...
										return n.abrupt("return", c.v);
									case 4:
										n.next = 9;
										break;
									case 6:
										return n.prev = 6, n.t0 = n["catch"](0), n.abrupt("return", i(n.t0));
									case 9:
									case "end":
										return n.stop()
									}
					...
					value: function(t, n) {
						var i = this;
						return new Promise(function() {
							var o = r(regeneratorRuntime.mark(function a(r, o) {
								var s, u, c, l;
								return regeneratorRuntime.wrap(function(i) {
									for (;;) switch (i.prev = i.next) {
									case 0:
										return i.prev = 0, s = t.getData().instanceTree, i.next = 4, e.getLeafNodes(t, n);
									case 4:
										for (u = i.sent, c = [], l = 0; l < u.length; ++l) s.enumNodeFragments(u[l], function(e) {
											c.push(e)
										});
										return i.abrupt("return", r(c));
									case 10:
										return i.prev = 10, i.t0 = i["catch"](0), i.abrupt("return", o(i.t0));
									case 13:
									case "end":
										return i.stop()
									}
						...
						return new Promise(function() {
							var o = r(regeneratorRuntime.mark(function a(r, o) {
								...
								return regeneratorRuntime.wrap(function(i) {
									for (;;) switch (i.prev = i.next) {
									case 0:
										return i.prev = 0, i.next = 3, e.getFragIds(t, n);
									case 3:
										if (s = i.sent, s.length) {
											i.next = 6;
											break
										}
										return i.abrupt("return", o("No geometry, invalid dbId?"));
									case 6:
										return u = t.getFragmentList(), c = new THREE.Box3, l = new THREE.Box3, s.forEach(function(e) {
											u.getWorldBounds(e, c), l.union(c)
										}), i.abrupt("return", r(l));
									case 13:
										return i.prev = 13, i.t0 = i["catch"](0), i.abrupt("return", o(i.t0));
									case 16:
									case "end":
										return i.stop()
									}
					...
					value: function(e, t) {
						var n = this;
						return new Promise(function() {
							var i = r(regeneratorRuntime.mark(function o(r, i) {
								return regeneratorRuntime.wrap(function(n) {
									for (;;) switch (n.prev = n.next) {
									case 0:
										n.prev = 0, e.getProperties(t, function(e) {
											return e.properties ? r(e.properties) : i("No Properties")
										}), n.next = 7;
										break;
									case 4:
										return n.prev = 4, n.t0 = n["catch"](0), n.abrupt("return", i(n.t0));
									case 7:
									case "end":
										return n.stop()
									}
						...
						return new Promise(function() {
							var o = r(regeneratorRuntime.mark(function a(r, o) {
								return regeneratorRuntime.wrap(function(i) {
									for (;;) switch (i.prev = i.next) {
									case 0:
										i.prev = 0, e.getProperties(t, function(e) {
											e.properties ? (e.properties.forEach(function(e) {
												return n == e.displayName ? r(e) : void 0
											}), o(new Error("Not Found"))) : o(new Error("Error getting properties"))
										}), i.next = 7;
										break;
									case 4:
										return i.prev = 4, i.t0 = i["catch"](0), i.abrupt("return", o(i.t0));
									case 7:
									case "end":
										return i.stop()
									}
						...
						return new Promise(function() {
							var o = r(regeneratorRuntime.mark(function a(r, o) {
								...
								return regeneratorRuntime.wrap(function(i) {
									for (;;) switch (i.prev = i.next) {
									case 0:
										return i.prev = 0, s = n.map(function(n) {
											return e.getProperties(t, n)
										}), i.next = 4, Promise.all(s);
									case 4:
										return u = i.sent, c = [], u.forEach(function(e) {
											e.forEach(function(e) {
												c.indexOf(e.displayName) < 0 && c.push(e.displayName)
											})
										}), i.abrupt("return", r(c.sort()));
									case 10:
										return i.prev = 10, i.t0 = i["catch"](0), i.abrupt("return", o(i.t0));
									case 13:
									case "end":
					...
					value: function(t, n, i) {
						var o = this;
						return new Promise(function() {
							var a = r(regeneratorRuntime.mark(function s(a, u) {
								var c, l, f;
								return regeneratorRuntime.wrap(function(s) {
									for (;;) switch (s.prev = s.next) {
									case 0:
										return s.prev = 0, c = i.map(function(i) {
											return new Promise(function() {
												var a = r(regeneratorRuntime.mark(function s(r, a) {
													var u;
													return regeneratorRuntime.wrap(function(o) {
														for (;;) switch (o.prev = o.next) {
														case 0:
															return o.prev = 0, o.next = 3, e.getProperty(t, i, n);
														case 3:
															return u = o.sent, u.dbId = i, o.abrupt("return", r(u));
														case 8:
															if (o.prev = 8, o.t0 = o["catch"](0), "Not Found" != o.t0.message) {
																o.next = 14;
																break
															}
															return u = {
																displayValue: "Not Available"
															}, u.dbId = i, o.abrupt("return", r(u));
														case 14:
															return o.abrupt("return", a(o.t0));
														case 15:
														case "end":
															return o.stop()
														}
										...
										}), s.next = 4, Promise.all(c);
									case 4:
										return l = s.sent, f = {}, l.forEach(function(e) {
											var t = e.displayValue;
											"string" == typeof t && (t = t.split(":")[0]), f[t] || (f[t] = []), f[t].push(e.dbId)
										}), s.abrupt("return", a(f));
									case 10:
										return s.prev = 10, s.t0 = s["catch"](0), s.abrupt("return", u(s.t0));
									case 13:
									case "end":
										return s.stop()
									}
					...
					value: function(e, t, n) {
						function r(t, n) {
							for (var r = [], i = 0; i < t.length; i += 2) {
								...
								s.vertices.push(new THREE.Vector3(o.x, o.y, o.z)), s.vertices.push(new THREE.Vector3(a.x, a.y, a.z)), s.computeLineDistances();
								var u = new THREE.Line(s, n);
								e.impl.scene.add(u), r.push(u)
							}
							return r
						}
						var i = arguments.length <= 3 || void 0 === arguments[3] ? null : arguments[3],
							o = i;
						o || (o = new THREE.LineBasicMaterial({
							color: 16776960,
							linewidth: 2
						}), e.impl.matman().addMaterial("ADN-Material-Line", o, !0));
						var a = r([{
							x: t.x,
							y: t.y,
							z: t.z
						...
						return e.impl.sceneUpdated(!0), a
					}
				}, {
					key: "setMaterial",
					value: function() {
						...
						var n = r(regeneratorRuntime.mark(function i(t, n, r) {
							var o;
							return regeneratorRuntime.wrap(function(i) {
								for (;;) switch (i.prev = i.next) {
								case 0:
									return i.next = 2, e.getFragIds(t, n);
								case 2:
									o = i.sent, o.forEach(function(e) {
										t.getFragmentList().setMaterial(e, r)
									});
								case 4:
								case "end":
									return i.stop()
					...
					value: function(e) {
						function t(e) {
							r.enumNodeChildren(e.dbId, function(i) {
								var o = null;
								n ? o = n(i) : (e.children = e.children || [], o = {
									dbId: i,
									name: r.getNodeName(i)
								}, e.children.push(o)), t(o)
							})
						}
						var n = arguments.length <= 1 || void 0 === arguments[1] ? null : arguments[1],
							r = e.getData().instanceTree,
							i = r.getRootId(),
							o = {
								dbId: i,
								name: r.getNodeName(i)
					...
					value: function(e, t) {
						function n(o) {
							i.enumNodeChildren(o, function(i) {
								r.push(t(e, i)), n(i)
							})
						}
						var r = [],
							i = e.getData().instanceTree,
							o = i.getRootId();
						return n(o), r
					}
				}, {
		...
		6: function(e, t) {
			...
			var a = function(e) {
					function t(e) {
						...
						n(this, t);
						var o = r(this, Object.getPrototypeOf(t).call(this, e, i));
						return o._viewer = e, o._options = i, o
					}
					return i(t, e), o(t, [{
						key: "load",
						value: function() {
				...
				var o = function c(e, t, n) {
					...
					u = function(t) {
						function u(e, t) {
							...
							n(this, u);
							var o = r(this, Object.getPrototypeOf(u).call(this, e, u.guid(), t, Object.assign(s, i)));
							return o._dialogResult = "CANCEL", o._events = {}, o._isVisible = !1, o._isMinimized = !1, o._btnElement = i.buttonElement, o
						}
						return i(u, t), a(u, null, [{
							key: "guid",
							value: function c() {
								var e = arguments.length <= 0 || void 0 === arguments[0] ? "xxxxxxxxxx" : arguments[0],
									t = (new Date).getTime(),
									c = e.replace(/[xy]/g, function(e) {
							...
							key: "unload",
							value: function() {
								this.setVisible(!1), e(this.container).remove()
							}
						}, {
							key: "isVisible",
							value: function() {
							...
							value: function() {
								...
								e !== this._isVisible && "undefined" != typeof this._events && this.emit(e ? "open" : "close", {
									result: this._dialogResult
								}), this._isVisible = e, this._btnElement && (e ? this._btnElement.classList.add("active") : this._btnElement.classList.remove("active")), o(Object.getPrototypeOf(u.prototype), "setVisible", this).call(this, e)
							}
						}, {
							...
							key: "initialize",
							value: function() {
								this.title = this.createTitleBar(this.titleLabel || this.container.id), this.container.appendChild(this.title), this.setTitle(this.titleLabel || this.container.id, this.options), this.options.movable && this.initializeMoveHandlers(this.title), this.options.closable && (this.closer = this.createCloseButton(), this.container.appendChild(this.closer));
								var t = e(this.htmlContent(this.container.id));
								this.content = t[0], e(this.container).append(t)
							}
						}, {
							key: "onTitleDoubleClick",
							value: function(t) {
								this._isMinimized = !this._isMinimized, this._isMinimized ? (this._height = e(this.container).css("height"), e(this.container).css({
									height: "34px",
									"min-height": "34px"
							...
							key: "on",
							value: function(e, t) {
								return this._events[e] = this._events[e] || [], this._events[e].push(t), t
							}
						}, {
							key: "off",
							value: function(e, t) {
							...
							key: "emit",
							value: function(e) {
								if (void 0 !== this._events[e]) for (var t = this._events[e].slice(), n = 0; n < t.length; ++n) {
									var r = t[n].apply(this, Array.prototype.slice.call(arguments, 1));
		...
		13: function(e, t, n) {
			...
			}).call(t, n(13).setImmediate, n(13).clearImmediate)
		},
		20: function(e, t) {
			e.exports = function(e, t) {
				...
				o = function() {
					...
					return i(e, [{
						...
						value: function() {
							...
							var t = n(regeneratorRuntime.mark(function r(e) {
								var t, n;
								return regeneratorRuntime.wrap(function(r) {
									for (;;) switch (r.prev = r.next) {
									case 0:
										return t = this._apiUrl + ("/models/" + e + "/states/sequence"), r.next = 3, fetch(t);
									case 3:
						...
						value: function() {
							...
							var t = n(regeneratorRuntime.mark(function r(e) {
								...
								return regeneratorRuntime.wrap(function(r) {
									for (;;) switch (r.prev = r.next) {
									case 0:
										return t = this._apiUrl + ("/models/" + e + "/states"), r.next = 3, fetch(t);
									case 3:
										return n = r.sent, r.abrupt("return", n.json());
									case 5:
									case "end":
						...
						value: function() {
							...
							var t = n(regeneratorRuntime.mark(function r(e, t) {
								var n;
								return regeneratorRuntime.wrap(function(r) {
									for (;;) switch (r.prev = r.next) {
									case 0:
										return r.next = 2, fetch(e, {
											method: "post",
											headers: {
							...
							var t = n(regeneratorRuntime.mark(function r(e, t) {
								...
								return regeneratorRuntime.wrap(function(r) {
									...
									case 0:
										return n = {
											sequence: t
										}, i = this._apiUrl + ("/models/" + e + "/states/sequence"), r.abrupt("return", this.post(i, n));
									case 3:
									case "end":
										return r.stop()
									}
							...
							var t = n(regeneratorRuntime.mark(function r(e, t) {
								...
								return regeneratorRuntime.wrap(function(r) {
									...
									case 0:
										return n = {
											state: t
										}, i = this._apiUrl + ("/models/" + e + "/states"), r.abrupt("return", this.post(i, n));
									case 3:
									case "end":
										return r.stop()
									}
						...
						key: "removeState",
						value: function(e, t) {
							var n = this._apiUrl + ("/models/" + e + "/states/" + t + "/remove");
							return this.post(n)
						}
					}]), e
				}();
		...
		43: function(e, t, n) {
			(function(e) {
				...
				var p = function(t) {
						function n(t, r) {
							i(this, n);
							var a = o(this, Object.getPrototypeOf(n).call(this, t, "定义视角", {
								buttonElement: r,
								shadow: !0
							}));
							return e(a.container).addClass("state-manager"), e("#" + a.container.id + "-save-btn").click(function(t) {
								var n = e("#" + a.container.id + "-name"),
									r = a.emit("state.add", {
										name: n.val()
									});
								a.addItem(r), n.val("")
							}), a.drake = (0, f["default"])([e("#" + a.container.id + "-item-list")[0]], {
								removeOnSpill: !1
							}), a.drake.on("drop", function() {
								var t = [];
								e("#" + a.container.id + "-item-list > div").each(function(e, n) {
									t.push(n.id)
								}), a.emit("sequence.update", t)
							}), a.drake.on("drag", function(e) {}), a
						}
						return a(n, t), s(n, [{
							key: "htmlContent",
							value: function(e) {
								var stateManager = $(".state-manager");
								if(stateManager != undefined && stateManager.length > 0){
									stateManager.remove();
								}
								return '\n\n      <div class="container">\n        <div>\n          <button id="' + e + '-save-btn"\n                  class="btn btn-info btn-save">\n            <span class="glyphicon glyphicon-save-file btn-span-list" style="margin-top: 14px;">\n            </span>\n            保存视角\n          </button>\n        </div>\n        <input id="' + e + '-name" type="text" class="input-name"\n               placeholder="输入视角名称">\n        <div class="item-list" id="' + e + '-item-list">\n        </div>\n      </div>'
							}
						}, {
							key: "addItem",
							value: function(t) {
								...
								if(value == ""){
									XiaBootStrapNotice.info("请输入视角名称！");
									return;
								}else if(value.length > 8){
									XiaBootStrapNotice.info("视角名称长度不能超过8个中英文字！");
									return;
								}
								...
								var n = this,
									r = '\n\n        <div id="' + guid + '" class="state-list-group-item" style="width: calc(100% - 40px);">\n            ' + t.name + '\n             <button id="' + guid + '-delete-btn"\n                    class="btn btn-danger state-btn-list">\n              <span class="glyphicon glyphicon-remove state-btn-span-list">\n              </span>\n            </button>\n        </div>\n      ';
								e("#" + this.container.id + "-item-list").append(r), t.readonly && e("#" + guid + "-delete-btn").css({
									display: "none"
								});
								
								var isFirstPerson = false;
								if($("#toolbar-firstPersonTool") != undefined 
										&& $("#toolbar-firstPersonTool")[0].className.indexOf("active") != -1 
										&& $("#toolbar-firstPersonTool")[0].className.indexOf("inactive") == -1){
									isFirstPerson = true;
								}
							    ...
							    state.name = value;
								 ...
								 var dto = {
									visualAngleName:value,
									visualAngleCode:guid,
									urn:t.seedURN,
									translateX:viewer.getCamera().position.x,
									translateY:viewer.getCamera().position.y,
									translateZ:viewer.getCamera().position.z,
									targetX:viewer.getCamera().target.x,
									targetY:viewer.getCamera().target.y,
									targetZ:viewer.getCamera().target.z,
									firstPerson:isFirstPerson,
									state:JSON.stringify(state)
					            };
								//保存视角信息到数据库
								$.ajax({
					                url: "/bim002/saveBimVisualAngle",
					                type: "POST",
								...
								var i = e("#" + guid);
								e("#" + guid + "-delete-btn").click(function(e) {
									n.emit("state.remove", t), i.remove();
									//删除数据库中的视角
									$.ajax({
						                url: "/bim002/deleteBimVisualAngle/"+guid,
						                type: "DELETE",
						                success: function(response){
									...
									e.preventDefault();
									var r = document.elementFromPoint(e.pageX, e.pageY);
									r.className.indexOf("list-group-item") > -1 && n.emit("state.restore", t);
								})
							}
						}]), n
					}(c["default"]);
				...
				return void 0 === e && (e = {}), e.on = function(t, n) {
					...
					return function() {
						...
						return a.forEach(function(r) {
							n.async ? i(r, o, s) : r.apply(s, o), r._once && e.off(t, r)
						}), e
					}
				}, e
			}
		...
		55: function(e, t, n) {
			(function(t) {
				...
				function s(e, t, n) {
					function r() {
						var e;
						return h.createEvent ? (e = h.createEvent("Event"), e.initEvent(t, !0, !0)) : h.createEventObject && (e = h.createEventObject()), e
					}
					function i() {
						return new p(t, {
							detail: n
					...
					var o = -1 === d.indexOf(t) ? i() : r();
					e.dispatchEvent ? e.dispatchEvent(o) : e.fireEvent("on" + t, o)
				}
				function u(e, n, r) {
					return function(n) {
						var i = n || t.event;
						i.target = i.target || i.srcElement, i.preventDefault = i.preventDefault ||
						function() {
							i.returnValue = !1
				...
				function l(e, t, n) {
					...
					if (r) {
						var i = m[r].wrapper;
						return m.splice(r, 1), i
					}
				}
				function f(e, t, n) {
					var r, i;
					for (r = 0; r < m.length; r++) if (i = m[r], i.element === e && i.type === t && i.fn === n) return r
				}
				var p = n(73),
					d = n(56),
					h = t.document,
					...
					g = o,
					m = [];
				t.addEventListener || (v = i, g = a), e.exports = {
					add: v,
					remove: g,
					fabricate: s
				}
		...
		73: function(e, t) {
			(function(t) {
				...
				var r = t.CustomEvent;
				e.exports = n() ? r : "function" == typeof document.createEvent ?
				function(e, t) {
		...
		79: function(e, t) {
			...
			function n(e) {
				var t = o[e];
				return t ? t.lastIndex = 0 : o[e] = t = new RegExp(a + e + s, "g"), t
			}
			function r(e, t) {
				var r = e.className;
				r.length ? n(t).test(r) || (e.className += " " + t) : e.className = t
			}
			function i(e, t) {
				e.className = e.className.replace(n(t), " ").trim()
			}
			var o = {},
				a = "(?:^|\\s)",
				s = "(?:\\s|$)";
		...
		80: function(e, t, n) {
			(function(t) {
				...
				function r(e, t) {
					...
					function r(e) {
						var t = e ? "remove" : "add";
						i(C, t, "mousedown", E), i(C, t, "mouseup", R)
					}
					function s(e) {
						var t = e ? "remove" : "add";
						i(C, t, "mousemove", S)
					...
					function v(e) {
						var t = e ? "remove" : "add";
						b[t](C, "selectstart", k), b[t](C, "click", k)
					}
					function m() {
						r(!0), R({})
					}
					...
					function E(e) {
						ee = e.clientX, te = e.clientY;
						var t = 1 !== o(e) || e.metaKey || e.ctrlKey;
						if (!t) {
							var n = e.target,
								r = N(n);
							r && (ae = r, s(), "mousedown" === e.type && (h(n) ? n.focus() : e.preventDefault()))
						}
					}
					function S(e) {
						if (ae) {
							if (0 === o(e)) return void R({});
							if (void 0 === e.clientX || e.clientX !== ee || void 0 === e.clientY || e.clientY !== te) {
								if (ue.ignoreInputTextSelection) {
									var t = y("clientX", e),
										n = y("clientY", e),
										r = T.elementFromPoint(t, n);
									if (h(r)) return
								}
								var i = ae;
								s(!0), v(), D(), A(i);
								var u = a(Q);
								K = y("pageX", e) - u.left, Z = y("pageY", e) - u.top, w.add(ie || Q, "gu-transit"), W(), F(e)
							}
						}
					}
					function N(e) {
						if (!(ce.dragging && G || n(e))) {
							for (var t = e; d(e) && n(d(e)) === !1;) {
								if (ue.invalid(e, t)) return;
								if (e = d(e), !e) return
							}
							var r = d(e);
							if (r && !ue.invalid(e, t)) {
								var i = ue.moves(e, r, t, g(e));
								if (i) return {
									item: e,
									source: r
								}
					...
					function A(e) {
						X(e.item, e.source) && (ie = e.item.cloneNode(!0), ce.emit("cloned", ie, e.item, "copy")), J = e.source, Q = e.item, ne = re = g(e.item), ce.dragging = !0, ce.emit("drag", Q, J)
					}
					function O() {
						return !1
					}
					...
					function R(e) {
						if (_(), ce.dragging) {
							var t = ie || Q,
								...
								i = u(G, n, r),
								o = M(i, n, r);
							o && (ie && ue.copySortSource || !ie || o !== J) ? L(t, o) : ue.removeOnSpill ? P() : q()
						}
					}
					function L(e, t) {
						var n = d(e);
						ie && ue.copySortSource && t === J && n.removeChild(Q), H(t) ? ce.emit("cancel", e, J, J) : ce.emit("drop", e, t, J, re), I()
					}
					function P() {
						if (ce.dragging) {
							var e = ie || Q,
								t = d(e);
							t && t.removeChild(e), ce.emit(ie ? "cancel" : "remove", e, t, J), I()
						}
					}
					function q(e) {
						if (ce.dragging) {
							var t = arguments.length > 0 ? e : ue.revertOnSpill,
								n = ie || Q,
								r = d(n),
								i = H(r);
							i === !1 && t && (ie ? r.removeChild(ie) : J.insertBefore(n, ne)), i || t ? ce.emit("cancel", n, J, J) : ce.emit("drop", n, r, J, re), I()
						}
					}
					function I() {
						var e = ie || Q;
						_(), U(), e && w.rm(e, "gu-transit"), oe && clearTimeout(oe), ce.dragging = !1, se && ce.emit("out", e, se, J), ce.emit("dragend", e), J = Q = ie = ne = re = oe = se = null
					}
					function H(e, t) {
						var n;
						return n = void 0 !== t ? t : G ? re : g(ie || Q), e === J && n === ne
					}
					function M(e, t, r) {
						function i() {
							var i = n(o);
							...
							var a = $(o, e),
								s = V(o, a, t, r),
								u = H(o, s);
							return u ? !0 : ue.accepts(Q, o, J, s)
						}
						for (var o = e; o && !i();) o = d(o);
						return o
					}
					function F(e) {
						function t(e) {
						...
						if (G) {
							...
							var i = y("clientX", e),
								...
								a = i - K,
								s = o - Z;
							G.style.left = a + "px", G.style.top = s + "px";
							var c = ie || Q,
								l = u(G, i, o),
								f = M(l, i, o),
								p = null !== f && f !== se;
							(p || null === f) && (r(), se = f, n());
							var h = d(c);
							if (f === J && ie && !ue.copySortSource) return void(h && h.removeChild(c));
							var v, m = $(f, l);
							if (null !== m) v = V(f, m, i, o);
							else {
								if (ue.revertOnSpill !== !0 || ie) return void(ie && h && h.removeChild(c));
								v = ne, f = J
							}(null === v && p || v !== c && v !== g(c)) && (re = v, f.insertBefore(c, v), ce.emit("shadow", c, f, J))
						}
					}
					function z(e) {
						w.rm(e, "gu-hide")
					...
					function B(e) {
						ce.dragging && w.add(e, "gu-hide")
					}
					function W() {
						if (!G) {
							var e = Q.getBoundingClientRect();
							G = Q.cloneNode(!0), G.style.width = f(e) + "px", G.style.height = p(e) + "px", w.rm(G, "gu-transit"), w.add(G, "gu-mirror"), ue.mirrorContainer.appendChild(G), i(C, "add", "mousemove", F), w.add(ue.mirrorContainer, "gu-unselectable"), ce.emit("cloned", G, Q, "mirror")
						}
					}
					function U() {
						G && (w.rm(ue.mirrorContainer, "gu-unselectable"), i(C, "remove", "mousemove", F), d(G).removeChild(G), G = null)
					}
					function $(e, t) {
						for (var n = t; n !== e && d(n) !== e;) n = d(n);
						return n === C ? null : n
					}
					function V(e, t, n, r) {
						function i() {
					...
					return ue.removeOnSpill === !0 && ce.on("over", z).on("out", B), r(), ce
				}
				function i(e, n, r, i) {
					var o = {
						mouseup: "touchend",
					...
					t.navigator.pointerEnabled ? b[n](e, a[r], i) : t.navigator.msPointerEnabled ? b[n](e, s[r], i) : (b[n](e, o[r], i), b[n](e, r, i))
				}
				function o(e) {
				...
				function s(e, n) {
					return "undefined" != typeof t[n] ? t[n] : C.clientHeight ? C[e] : T.body[e]
				}
				function u(e, t, n) {
					var r, i = e || {},
						o = i.className;
					return i.className += " gu-hide", r = T.elementFromPoint(t, n), i.className = o, r
				}
				function c() {
					return !1
				}
				...
				function d(e) {
					return e.parentNode === T ? null : e.parentNode
				}
				function h(e) {
					return "INPUT" === e.tagName || "TEXTAREA" === e.tagName || "SELECT" === e.tagName || v(e)
				}
				function v(e) {
					return e ? "false" === e.contentEditable ? !1 : "true" === e.contentEditable ? !0 : v(d(e)) : !1
				}
				function g(e) {
					function t() {
						var t = e;
